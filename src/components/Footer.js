            ...
            <footer>
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b">
                    ...
                    {/* <div className="col-span-12 lg:col-span-4">
                        <h1 className="font-extrabold text-4xl text-blue-900">Sign Connect</h1>
                    </div> */}

                    {/* 2nd block */}
                    {/* <div className="col-span-6 md:col-span-6 lg:col-span-2 ml-7 mx-auto">
                        <h6 className="text-[#013289] text-xl font-bold">About</h6>
                    </div> */}

                    {/* 3rd block */}
                    {/* <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        <h6 className="text-[#013289] text-xl font-bold">Courses</h6>
                    </div> */}
